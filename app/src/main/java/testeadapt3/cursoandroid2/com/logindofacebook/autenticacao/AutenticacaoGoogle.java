...
import testeadapt3.cursoandroid2.com.logindofacebook.MainActivity;
import testeadapt3.cursoandroid2.com.logindofacebook.R;
/**
 * Created by laianeoliveira on 20/02/18.
 */
public class AutenticacaoGoogle extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
            ...
            public void onClick(View v) {
                ...
                Auth.GoogleSignInApi.signOut(mGoogleApiClient).setResultCallback(new ResultCallback<Status>() {
                    ...
                    public void onResult(@NonNull Status status) {
                        toastMessage("excluindo conta");
                        Intent intent = new Intent(AutenticacaoGoogle.this, MainActivity.class);
